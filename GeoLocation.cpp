...
void showCase() {
    ...
    //multiBoxGeo results = rtree.SearchTree(test.createBoundingBox(7.73243, 45.2063, 7.73252, 45.2071), "../switzerland_raw/rtree_build");
    //rtree.SetupForSearch("../switzerland");
    auto startTime = std::chrono::high_resolution_clock::now();
    ...
    multiBoxGeo results = rtree.SearchTree(BasicGeometry::CreateBoundingBox(5.956142, 46.132035, 5.956142, 46.132035), "../switzerland");
    /*for(RTreeValue result : results) {
