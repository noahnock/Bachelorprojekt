...
struct RectanglesForOrderedBoxes {
    multiBoxWithOrderIndex rectanglesInRam;
    multiBoxWithOrderIndex rectanglesSmall;
    std::string rectanglesOnDisk;

    RectanglesForOrderedBoxes() {
        rectanglesInRam = multiBoxWithOrderIndex();
        rectanglesSmall = multiBoxWithOrderIndex();
        rectanglesOnDisk = "";
    }

    /*RectanglesForOrderedBoxes(RectanglesForOrderedBoxes& other) {
        rectanglesInRam = other.rectanglesInRam;
        rectanglesSmall = other.rectanglesSmall;
        rectanglesOnDisk = other.rectanglesOnDisk;
    }*/
};
...
public: // TODO
    ...
    /*std::pair<Rtree::BoundingBox, Rtree::BoundingBox> PerformSplit(
            SplitResult splitResult, SplitBuffers& splitBuffersRam, size_t M,
            size_t S);*/
    // ___________________________________________________________________________
    // Actually splitting the rectangles at the given split by splitResult
